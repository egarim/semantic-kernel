...
public class TextMemoryPlugin_XpoMemoryStoreMySql(ITestOutputHelper output) : BaseTest(output)
{
    ...
    public async Task RunAsync()
    {
        ...
        cnx = "XpoProvider=MySql;Server=127.0.0.1;User ID=root;Password=ABCD1234!;Database=XpoKernelMemory;Persist Security Info= true;Charset=utf8";
